          ...
          <div className="bg-white rounded-2xl shadow-2xl p-6 border border-gray-100">
            ...
            <div className="flex gap-3 mb-4">
              <div className="flex-1 bg-gray-50 rounded-xl p-4">
                <p className="text-xs text-gray-400 mb-1">{t("maintenanceFees")}</p>
              ...
              <div className="flex-1 bg-gray-50 rounded-xl p-4">
                <p className="text-xs text-gray-400 mb-1">{t("totalExpenses")}</p>
            ...
            <div className="space-y-0">
              <div className="flex items-center gap-3 py-3 border-t border-gray-100">
                ...
                <span className="text-sm text-gray-700 flex-1">{t("poolMaintenance")}</span>
                <span className="text-sm font-semibold text-gray-800">$1,250</span>
                <span className="bg-green-50 text-green-600 text-xs font-medium px-2.5 py-1 rounded-full">{t("paid")}</span>
              </div>
              <div className="flex items-center gap-3 py-3 border-t border-gray-100">
                <div className="w-2 h-2 rounded-full bg-amber-500" />
                <span className="text-sm text-gray-700 flex-1">{t("gardenService")}</span>
            ...
            <div className="mt-4 pt-4 border-t border-gray-100 text-center">
              ...
              <p className="text-xs text-gray-400 mt-0.5">{t("activeRequests")}</p>
            </div>
          </div>
        </div>
      </div>
